...
pub fn update_market(
    ...
    ctx.accounts.market.withdrawal_fee_in_bps_hundredths = new_withdrawal_fee_in_bps_hundredths
        .unwrap_or(ctx.accounts.market.withdrawal_fee_in_bps_hundredths);
