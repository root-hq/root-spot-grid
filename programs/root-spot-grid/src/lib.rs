...
pub mod root_spot_grid {
    ...
    pub fn initialize_market(
        ...
        instructions::initialize_market(ctx, min_order_spacing_bps, protocol_fee_per_fill_bps)
    }
    ...
    pub fn update_market(
        ...
        instructions::update_market(ctx, new_min_order_spacing_bps, new_protocol_fee_per_fill_bps)
    }
